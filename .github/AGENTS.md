...
- **Node version mismatch:** `.nvmrc` says 18.20.8 but `package.json` requires `>=22.12.0` and Docker uses `node:22-alpine`. Use Node 22+.
...
- **Stale README:** Still shows Astro starter boilerplate, not project docs.
